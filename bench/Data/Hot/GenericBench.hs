...
benchmarks = bgroup "Hot"
  ...
  , bgroup "merge"
    [ bgroup "2 3"
      ...
      , bench "impl2" $ whnf (merge2 (Hot2 1 3)) (Hot3 2 4 6 :: Hot3 Int)
      --, bench "list" $ nf (L.merge [1, 3]) ([2, 4, 6] :: [Int])
      ]
    , bgroup "4 6"
      [ bench "impl" $ whnf (merge (Hot4 1 3 5 7)) (Hot6 2 4 6 8 10 12 :: Hot6 Int)
      , bench "impl2" $ whnf (merge2 (Hot4 1 3 5 7)) (Hot6 2 4 6 8 10 12 :: Hot6 Int)
    ...
    , bgroup "9 1"
      ...
      , bench "impl2" $ whnf (merge2 (Hot9 1 2 3 4 5 6 7 8 9)) (Hot1 2 :: Hot1 Int)
      ]
    ]
  , bgroup "sort"
    [ bgroup "10"
